...
@Component({
  selector: 'app-touarga',
  templateUrl: './touarga.component.html',
  styleUrl: './touarga.component.css'
})
export class TouargaComponent implements AfterViewInit {
  ...
  private loadData(L: any): void {
    this.redalservice.getTouarga().subscribe(
      (data: any[]) => {
        if (this.map) {
